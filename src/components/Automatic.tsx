  ...
  md:flex md:items-center">
        ...
        <div className="my-12 mx-auto font-inter md:max-w-5xl ">
          ...
          <FadeUp className="text-center mb-4 tracking-heading md:flex md:justify-center leading-tight">
            <h2 className="text-[26px] md:text-[24px] font-medium">
              Support, Training, &
            </h2>
            <h2 className="text-[26px] md:text-[24px] font-medium text-[#1976D2]  ">
              Onboarding
            </h2>
          </FadeUp>
            ...
            <FadeUp className="relative w-full max-w-[354px] md:max-w-none h-[370px] lg:h-[400px] mx-auto">
              ...
              >
                ...
                >
                  ...
                  {/* Content */}
                  <div className="px-4 md:p-4 flex-1 md:space-y-[24px]">
                    ...
                    <p className="absolute bottom-2 left-4 text-[16px] md:text-[16px] text-[#1976D2] font-bold leading-tight inline-block">
              ...
              >
                ...
                >
                  ...
                  <div className="md:p-4 flex-1 relative">
                    ...
                    <p className="text-[#737373] text-fluid-small tracking-para text-center">
