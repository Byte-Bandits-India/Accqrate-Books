    ...
    <>
      <section id="OnboardSection" className="w-full mt-[32px] md:mt-[56px]">
        <div className="px-[24px] md:px-[32px] max-w-[1280px] mx-auto font-inter">
          {/* Heading */}
          <FadeUp>
            <h2 className="text-[24px] leading-tight tracking-heading md:text-[32px] lg:text-[36px] font-inter text-[#000000] text-center mb-2 md:mb-6">
              Effortless <span className="text-[#1976D2]">Onboarding</span> & <br />
              Flexible Deployment
            </h2>

            {/* Shared description */}
            <p className=" md:mb-[32px] mb-4  tracking-para text-[#737373] lg:text-fluid-body text-[14px] md:text-[16px] text-center">
          ...
          <FadeUp>
            <h1 className="text-[24px] md:text-fluid-h2 font-medium tracking-heading text-center mb-2 sm:mb-6">
              <span className="text-[#1976D2]">Zero-Friction</span> Setup
            </h1>
            <p className="text-center px-1 text-[#9D9D9D] tracking-para text-[14px] md:text-fluid-body max-w-5xl mx-auto pb-6">
        ...
        <div className="mt-[48px] md:mt-[56px] max-w-[1280px] mx-auto font-inter text-center px-6 md:px-[32px]">
          <FadeUp>
            ...
            <h2 className="hidden lg:block text-fluid-h2 text-[#333333] tracking-heading leading-tight font-medium mb-[24px]">
              100% <span className="text-[#1976D2]">ZATCA</span> Phase 2 E-Invoicing
              Compliance
            </h2>

            <p className="text-center text-fluid-body lg:text-[20px] mb-[24px] leading-tight tracking-para md:mb-[32px] text-[#737373] leading-relaxed">
