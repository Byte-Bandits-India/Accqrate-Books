...
export default function Hero(): JSX.Element {
  ...
  return (
    ...
    >
      <div className="w-full max-w-[1280px] mx-auto mt-[62px] md:mt-[90px] mb-[40px]">
        {/* Headings */}
        ...
        <div className="max-w-[1000px] mx-auto">
          <h2 className="text-[20px] md:text-[24px] tracking-para lg:text-[30px] font-medium text-[#333333] tracking-wide mb-[24px]">
            <span className="text-[#1976D2] font-medium ">ZATCA Approved</span>{" "}
            Accounting Software for Saudi Arabia
          </h2>
          <p className="text-[14px]  md:text-[18px] text-[#333333] lg:text-[20px] tracking-para md:font-semibold md:leading-10 mb-[16px] md:mb-[24px]">
      ...
      <FadeUp className="mb-[20px] md:mb-[40px]">
        <h3 className="text-[16px] md:text-[16px] lg:text-[20px] font-medium text-[#333333] text-center mx-auto tracking-para">
